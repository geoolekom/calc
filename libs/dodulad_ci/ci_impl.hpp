...
//		std::cout << "xi " << xi << std::endl;
	...
	template <typename Map>
	int gen(double tt, int k, int nk_rad1, int nk_rad2, Map& xyz2i1, Map& xyz2i2, double a, double m1, double m2,
...
//		std::cout << korobov_grid.size() << std::endl;
		...
		for (korobov::Grid::iterator iter = korobov_grid.begin(); iter != korobov_grid.end(); ++iter) {
